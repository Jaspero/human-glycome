<div class="grid jc-center bg-img p-y-m">
  <div class="col-6 col-m-8 col-s-10 col-xs-12">
    <h1 class="c-dt-primary"><span class="title-dt">Privacy Policy</span></h1>
  </div>
</div>
  ...
  <div class="grid jc-center">
    <div class="col-6 col-m-8 col-s-10 col-xs-12">
      <div class="read-format">
        ...
        <p>
          The Human Glycome Project ("us", "we", or "our") operates the
          https://human-glycome.org website (the "Service").
        </p>

        <p>
          This page informs you of our policies regarding the collection, use,
          and disclosure of personal data when you use our Service and the
          choices you have associated with that data. Our Privacy Policy for The
          Human Glycome Project is managed through <a
            href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php"
            >Free Privacy Policy</a
          >.
        </p>
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://human-glycome.org
        </p>
        ...
        <h2>Use of Data</h2>
        <p>
          The Human Glycome Project uses the collected data for various
          purposes:
        </p>
        <ul>
        ...
        <p>
          If you are located outside Croatia and choose to provide information
          to us, please note that we transfer the data, including Personal Data,
          to Croatia and process it there.
        </p>
        <p>
        ...
        <p>
          The Human Glycome Project will take all steps reasonably necessary to
        ...
        <p>
          The Human Glycome Project may disclose your Personal Data in the good
          faith belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of The Human Glycome
            Project
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@human-glycome.org</li>
        </ul>
      </div>
    </div>
  </div>
